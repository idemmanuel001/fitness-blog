...
const Footer = () => {
  ...
  return (
    <footer className="w-full h-fit">
      <div className="flex flex-col justify-center items-center px-6 py-6 w-full bg-clear-day">
        <div className="w-full h-full max-w-lg flex flex-col justify-center mb-4 items-center">
          <h2 className="mb-2 font-bold text-center w-full text-raisin-black">
            SUBSCRIBE AND DON'T MISS NEW ARTICLES
          </h2>

          <p className="text-center text-sm full">
        ...
        <div className="flex flex-col items-center w-full justify-center">
          ...
          >
            <div className="flex flex-col w-full md:w-32 mb-3 md:mb-0 items-start md:mr-4 ">
            ...
            <div className="flex flex-col md:w-52 w-full mb-3 md:mb-0 items-start md:mr-4 ">
            ...
            <button
              className='md:py-1 p-3 transition duration-300 hover:text-raisin-black md:px-3 w-full md:w-28 bg-dark-green text-white text-sm font-semibold '
      ...
      <div className="flex justify-center items-center h-fit py-4 bg-raisin-black text-lavender ">
        <p className="text-center max-w-lg w-full text-sm py-4 font-semibold px-6 ">
